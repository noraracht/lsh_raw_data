...
* Query summary reports for GORG samples:
    - default settings: [kraken results](https://github.com/noraracht/lsh_raw_data/tree/main/gorg_default_kraken) and  [consult results](https://github.com/noraracht/lsh_raw_data/tree/main/gorg_default_consult)
